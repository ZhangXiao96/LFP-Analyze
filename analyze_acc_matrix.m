...
weights_flag = false; % boolean variable, e.g. true: use weights in SVM to balance data.
downsample_flag = true; % boolean variable, e.g. true: balance data by downsampling.
