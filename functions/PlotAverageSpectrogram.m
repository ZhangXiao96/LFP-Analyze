function PlotAverageSpectrogram( X_tf, y, t_length, f_length, channel, max_limit, min_limit )
% PLOTAVERAGESPECTROGRAMS: plot average spectrogram of X_tf.
% inputs:
