function [X_targ, X_result, Direction, Option, Reward]= ExtractData( input_file_dirs, output_file_dirs )
% ExtractData: extract data (including the target part and the result part)
%              from the files and save it to output_file_dirs.
% 
% inputs:
%   input_file_dirs: dirs of the original file, e.g.'OriginalData/Igo08282012-01/'.
%   output_file_dirs: dirs of the folder to save the outputs, e.g. 'Data/0828/'.
% 
% outputs:
